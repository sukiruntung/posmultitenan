            ...
            <x-filament::card>
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-semibold text-blue-600">Rp {{ number_format($this->calculateSaldoSeharusnya()) }}</p>
                    </div>
                </div>
            </x-filament::card>
            ...
            <x-filament::card>
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-semibold {{ $this->selisih >= 0 ? 'text-yellow-600' : 'text-red-600' }}">Rp {{ number_format($this->selisih) }}</p>
                    </div>
                </div>
            </x-filament::card>
        </div>
