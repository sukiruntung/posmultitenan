...
class LaporanPembelian extends Page
{
    ...
    protected static string $view = 'filament.resources.laporan.laporan-pembelian';
    ...
    public function generateReport()
    {
        ...
        // Logic untuk generate laporan pembelian
        session()->flash('success', 'Laporan pembelian berhasil digenerate');
    }

    public function getTitle(): string
    {
        return 'Laporan Pembelian Periode';
    }
}